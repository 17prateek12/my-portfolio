const ProjectData = [
    {
        id: 1,
        title: <a href="https://weather-app-tau-indol.vercel.app/" target="_blank" style={{ textDecoration: 'none' ,color:'black' }}>WEATHER APP</a>,
        tech: 'React.JS',
        point2: [
        ...
        git: <a href="https://github.com/17prateek12/Weather_app" target="_blank" style={{ textDecoration: 'none' }}>GITHUB</a>
    },
    {
        id: 2,
